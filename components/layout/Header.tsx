				...
				<HStack className='h-16 mb-4' justifyContent='space-between'>
					...
					{!user ? (
						<HStack spacing={6}>
							...
							<span className='cursor-pointer' onClick={() => router.push('/register')}>
								Register
							</span>
						</HStack>
					) : (
						<HStack spacing={6}>
							...
							<Box className='cursor-pointer' _hover={{ color: 'frost.100' }} onClick={() => router.push('/battles')}>
								Battles
							</Box>
							<Menu>
								<MenuButton _hover={{ color: 'frost.100' }}>
							...
							<Box className='cursor-pointer' _hover={{ color: 'frost.100' }} onClick={() => router.push('/map')}>
								World Map
							</Box>
							<Menu>
								<MenuButton
					...
					<Menu>
						...
						{!user ? (
							...
							<MenuList bgColor='night.400'>
								...
								<MenuItem _hover={{ bg: 'frost.100' }} _focus={{ bg: 'frost.100' }} onClick={() => router.push('/map')}>
									World Map
								</MenuItem>
								<Accordion allowToggle>
									<AccordionItem>
