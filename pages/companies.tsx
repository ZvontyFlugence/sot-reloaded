	...
	return user ? (
		<Layout>
			<div className='flex flex-col w-full'>
				...
				<List className='mt-4' spacing={3} bgColor={useColorModeValue('snow.300', 'night.400')}>
					{companies.length > 0 ? (
						...
						<p className='py-2 px-4 rounded-lg shadow-md'>You do not own any companies</p>
					)}
				</List>
					...
					<ModalContent bgColor='night.400' color='snow.100'>
						...
						<ModalBody className='flex flex-col gap-4'>
							...
							<FormControl>
								...
								<Select
									className='relative border border-snow-100 rounded w-max'
									selected={type}
